...
// statut 'approuvee'         → approuvée, prête à décaisser
// statut 'decaissee'         → décaissée, crédit actif suivi par le caissier
...
const INITIAL = [
  ...
  // Crédits actifs (décaissés) — suivis par le caissier
